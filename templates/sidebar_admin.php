...
if (isset($current_page)) {
    if (stripos($current_page, 'gestion_usuarios') !== false) {
        $page_title = "Gestión de Usuarios";
        $page_icon = "fa-users";
    } else if (stripos($current_page, 'gestion_habitaciones') !== false) {
        $page_title = "Habitaciones";
        $page_icon = "fa-bed";
    } else if (stripos($current_page, 'gestion_reservas') !== false) {
        $page_title = "Reservas";
...
<div class="topbar">
    <div class="page-title">
        <h2><i class="fas <?= $page_icon ?>" style="margin-right: 12px; font-size: 1.4rem; color:#3b82f6;"></i> <?= $page_title ?></h2>
    </div>
    <div class="user-info">
