...
// Obtener datos de la reserva que esta en estado pendiente y que le pertenezca a ese cliente
try {
    $sql = $conexion->prepare("SELECT r.id, r.fecha_inicio, r.fecha_fin, r.total, rh.habitacion_id as habitacion_id FROM reservas r INNER JOIN reserva_habitacion rh ON r.id=rh.reserva_id WHERE r.id = :id_reserva AND r.cliente_id = :id_cliente AND r.estado='pendiente'");
...
?>
<link rel="stylesheet" href="<?= $base_url ?>app/css/cliente/editar_reserva.css">
    ...
    <div class="form-container">
        <div class="form-card">
            ...
            <div class="card-body">
                ...
                <form id="reservaForm" action="../controladores/cliente/editar_reserva.php" method="POST">
...
<script src="<?= $base_url ?>app/js/cliente/editar_reserva.js"></script>